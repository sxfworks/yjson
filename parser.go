...
var yyAct = [...]int{
	1, 15, 2, 3, 4, 6, 9, 7, 12, 5,
	17, 14, 16, 10, 11, 13, 19, 20, 8, 0,
	18,
}

var yyPact = [...]int{
	-3, -1000, -1000, -1000, -1000, -1000, 8, -3, 2, -1000,
	-13, -1, -1000, 8, -1000, -3, -3, -1000, -1000, -1000,
	-1000,
}
...
var yyChk = [...]int{
	-1000, -4, 5, 6, 7, 12, 8, 10, -1, -2,
	5, -3, -4, 13, 9, 14, 13, 11, -2, -4,
	-4,
}

var yyDef = [...]int{
	0, -2, 8, 9, 10, 11, 1, 5, 0, 2,
	0, 0, 6, 0, 12, 0, 0, 13, 3, 4,
	7,
}
...
yydefault:
	...
	case 8:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
			yyVAL.val = newString(yyDollar[1].val)
			maybeSetResult(yylex, yyVAL.val)
		}
	case 9:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
			yyVAL.val = newNumber(yyDollar[1].val)
			maybeSetResult(yylex, yyVAL.val)
		}
	case 10:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
			yyVAL.val = newLiteral(yyDollar[1].val)
			maybeSetResult(yylex, yyVAL.val)
		}
	case 11:
		yyDollar = yyS[yypt-1 : yypt+1]
		{
			yyVAL.val = newVariable(yyDollar[1].val)
			maybeSetResult(yylex, yyVAL.val)
		}
	case 12:
		yyDollar = yyS[yypt-3 : yypt+1]
		{
			yyVAL.val = newObject(yyDollar[2].obj)
			maybeSetResult(yylex, yyVAL.val)
		}
	case 13:
		yyDollar = yyS[yypt-3 : yypt+1]
		{
			yyVAL.val = newArray(yyDollar[2].list)
			maybeSetResult(yylex, yyVAL.val)
		}
	}
